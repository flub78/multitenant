...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Multitenant WEB Application</title>
    ...
    <body class="antialiased">
        ...
        -->
        <div class="navbar navbar-expand-sm navbar-dark bg-dark  pb-3 fixed-top" style="position: sticky;">
            @if (Route::has('login'))
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            ...
                            <a href="https://laravel.bigcartel.com" class="ml-1 underline text-light">
                                Shop
                            </a>
                            ...
                            <a href="https://github.com/sponsors/taylorotwell" class="ml-1 underline text-light">
                                Sponsor
                            </a>
                        </div>
                    </div>
