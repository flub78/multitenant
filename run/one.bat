...
@rem php vendor/phpunit/phpunit/phpunit  tests/Unit/Tenants/TenantTestCaseTest.php
...
@rem php vendor/phpunit/phpunit/phpunit  tests/Unit/Tenants/MotdTodayModelTest.php
...
@rem php vendor/phpunit/phpunit/phpunit tests/Feature/Central/TestControllerTest.php
